# মারকাযুল মদীনা — ম্যানেজমেন্ট সিস্টেম CLAUDE.md

## প্রজেক্ট পরিচয়

এটি একটি সম্পূর্ণ প্রতিষ্ঠান ব্যবস্থাপনা সিস্টেম। মুহতামিম (admin) একটি মাস্টার ড্যাশবোর্ড থেকে সব মডিউল দেখবেন ও নিয়ন্ত্রণ করবেন। প্রতিটি মডিউলের দায়িত্বশীলরা আলাদা আলাদা ডিভাইস থেকে লগইন করে তাদের কাজ করবেন।
