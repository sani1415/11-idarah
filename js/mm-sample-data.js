...
(function (g) {
  ...
  function buildMadrasaSample(today) {
    ...
    const logs = [
      ...
      { id: 'mm_ex_tlog_1', type: 'teacher', ref_id: 'tch_1', text: 'শ্রেণিকক্ষে সময়মতো উপস্থিত; ছাত্রদের সাথে আচরণ সদাচারণীয়।', date: today, by: 'মুহতামিম' },
      { id: 'mm_ex_tlog_2', type: 'teacher', ref_id: 'tch_1', text: 'মাসিক পাঠ পরিকল্পনা জমা দিয়েছেন।', date: '2025-03-10', by: 'মুহতামিম' },
      { id: 'mm_ex_tlog_3', type: 'teacher', ref_id: 'tch_2', text: 'ইয়াদা কক্ষ পরিচ্ছন্ন; ছাত্রদের স্বাস্থ্য ঠিকঠাক।', date: today, by: 'মুহতামিম' },
      { id: 'mm_ex_tlog_4', type: 'teacher', ref_id: 'tch_4', text: 'তৃতীয় বর্ষের বার্ষিক সভায় উপস্থিত।', date: '2025-04-10', by: 'মুহতামিম' },
      { id: 'mm_ex_tlog_5', type: 'teacher', ref_id: 'tch_10', text: 'মক্তব অভিভাবক সভায় ঠিকঠাক উপস্থিতি।', date: '2025-05-20', by: 'মুহতামিম' },
    ];
    const fees = [
  ...
  function buildChatSample() {
    ...
    return [
      ...
      msg('ch_02', 'daftar', 'admin', 'মুহতামিম', 'ঠিক আছে। অনুপস্থিতদের মধ্যে কেউ কি অসুস্থ? অভিভাবকদের জানানো হয়েছে কি?', 51),
      ...
      msg('ch_05', 'hifz', 'admin', 'মুহতামিম', 'মাশাআল্লাহ! তাদের উৎসাহিত করুন।', 27),
      msg('ch_06', 'khedmat', 'khedmat', 'খেদমত দায়িত্বশীল', 'আজ ৩ জন নতুন উপকারভোগী নিবন্ধন করা হয়েছে।', 50),
      msg('ch_07', 'khedmat', 'admin', 'মুহতামিম', 'তহবিল থেকে সহায়তা দিন।', 49),
      msg('ch_08', 'teacher-tch_4', 'teacher', 'উস্তায ইউসুফ', '৩য় বর্ষের হেদায়াতুন নাহু ৪৫ পৃষ্ঠা পর্যন্ত শেষ হয়েছে।', 26),
      msg('ch_09', 'teacher-tch_4', 'admin', 'মুহতামিম', 'আলহামদুলিল্লাহ। পরীক্ষার আগে ৬০ পৃষ্ঠা লক্ষ্য রাখবেন।', 25),
      ...
      msg('ch_12', 'alumni', 'admin', 'মুহতামিম', 'চমৎকার! তাদের সাথে নিয়মিত যোগাযোগ রাখুন।', 99),
    ];
  }
