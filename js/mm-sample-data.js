...
(function (g) {
  ...
  function buildMadrasaSample(today) {
    ...
    const students = [
      ...
      { id: 'std_22', permanent_id: '047101', name: 'আব্দুল্লাহ (ম.)', class_id: 'cls_m1', roll: 'ম১০১', guardian: 'নুর আলম', guardian_job: 'কৃষক', phone: '০১৭৪১-৪৪৪৪৪', district: 'কুমিল্লা', upazila: 'মক্তব ১', active: true, hifz: false },
      { id: 'std_23', permanent_id: '047102', name: 'আবু বকর (ম.)', class_id: 'cls_m1', roll: 'ম১০২', guardian: 'বকর সাহেব', guardian_job: 'রংমিস্ত্রি', phone: '০১৭৪২-৪৪৪৪৫', district: 'কুমিল্লা', upazila: 'মক্তব ১', active: true, hifz: false },
      { id: 'std_24', permanent_id: '047201', name: 'সুফিয়ান (ম.)', class_id: 'cls_m2', roll: 'ম২০১', guardian: 'সুহেল আহমেদ', guardian_job: 'কৃষক', phone: '০১৭৪৩-৪৪৪৪৬', district: 'কুমিল্লা', upazila: 'মক্তব ২', active: true, hifz: false },
      { id: 'std_25', permanent_id: '047202', name: 'সাবরিনা (ম.)', class_id: 'cls_m2', roll: 'ম২০২', guardian: 'নুরজাহান', guardian_job: '—', phone: '০১৭৪৪-৪৪৪৪৭', district: 'কুমিল্লা', upazila: 'মক্তব ২', active: true, hifz: false },
      { id: 'std_26', permanent_id: '047301', name: 'আরমান (ম.)', class_id: 'cls_m3', roll: 'ম৩০১', guardian: 'আরিফ', guardian_job: 'সেলুন', phone: '০১৭৪৫-৪৪৪৪৮', district: 'কুমিল্লা', upazila: 'মক্তব ৩', active: true, hifz: false },
      { id: 'std_27', permanent_id: '047302', name: 'আরোশ (ম.)', class_id: 'cls_m3', roll: 'ম৩০২', guardian: 'রোকেয়া', guardian_job: '—', phone: '০১৭৪৬-৪৪৪৪৯', district: 'কুমিল্লা', upazila: 'মক্তব ৩', active: true, hifz: false },
      { id: 'std_28', permanent_id: '047401', name: 'তাওহীদ (ম.)', class_id: 'cls_m4', roll: 'ম৪০১', guardian: 'তানভীর', guardian_job: 'কৃষক', phone: '০১৭৪৭-৪৪৪৫০', district: 'কুমিল্লা', upazila: 'মক্তব ৪', active: true, hifz: false },
      { id: 'std_29', permanent_id: '047402', name: 'তাওফিক (ম.)', class_id: 'cls_m4', roll: 'ম৪০২', guardian: 'তৌহিদ', guardian_job: 'রাজমিস্ত্রি', phone: '০১৭৪৮-৪৪৪৫১', district: 'কুমিল্লা', upazila: 'মক্তব ৪', active: true, hifz: false },
      { id: 'std_30', permanent_id: '047501', name: 'আরিফ (ম.)', class_id: 'cls_m5', roll: 'ম৫০১', guardian: 'আরিফ', guardian_job: 'রাজনীতি', phone: '০১৭৪৯-৪৪৪৫২', district: 'কুমিল্লা', upazila: 'মক্তব ৫', active: true, hifz: false },
      { id: 'std_31', permanent_id: '047502', name: 'আরমান (ম.)', class_id: 'cls_m5', roll: 'ম৫০২', guardian: 'আরিফ', guardian_job: 'ব্যবসা', phone: '০১৭৫০-৪৪৪৫৩', district: 'কুমিল্লা', upazila: 'মক্তব ৫', active: true, hifz: false },
    ];
    const kitabs = [
  ...
  function buildKhedmatSample() {
    ...
    return {
      ...
      mm_kh_daily_logs: [
        { id: 'lg_1', content: 'আজ ২ জন মাখদুমের সাথে কথা হয়েছে। আব্দুর রহিমের পরিবারের অবস্থা কিছুটা ভালো হয়েছে।', date: today, by: 'খেদমত দায়িত্বশীল' },
  ...
  function buildChatSample() {
    ...
    return [
      ...
      msg('ch_06', 'khedmat', 'khedmat', 'খেদমত দায়িত্বশীল', 'আজ ৩ জন নতুন মাখদুম নিবন্ধন করা হয়েছে।', 50),
